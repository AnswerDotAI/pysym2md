...
def pysym2md(
    ...
    include_no_docstring:<function store_true at 0x7f9c1afd14e0>=False, # Include symbols without docstrings?
    verbose:<function store_true at 0x7f9c1afd14e0>=False, # Turn on verbose logging?
